...
Tool Netflix Cli V1.0 dari eastlombok team,di buat oleh sayidina ahmadal qososyi,tool yang di gunakan untuk auto cek akun netflix target dengan emailnya.
...
```bash
git clone https://github.com/oendnsk675/netflix-cli-v1.0.git
```
